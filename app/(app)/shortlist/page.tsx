import { ShortlistList } from "@/components/shortlist-list"
import { getShortlistData } from "@/lib/bookmark-lists"
...
export default async function Page(props: {
  ...
  const data = await getShortlistData()
...
function normalizeSort(sort?: string): ShortlistSort {
